...
if marks > 0 and marks <= 100:
    ...
    if marks <= 60:
        print("User has failed to study")
else:
...
#Voter Eligibilty checkcase---->make sure to satisfy all possible conditions
#>=18 and 100---->Access
#18---->no of years eligibiltyshould te;;
#negative values--->not acceptable

age = int(input('Enter the age :'))
if age>=18 and age <= 100:
    print('-----User has Vote eligibilty----')
    print('-----Access granted------')
elif age<=18 and age >0:
    print('-----User still need to get Vote eligibilty----')
    print('-----User need to wait for more',(18-age), 'year(s)-----')
else:
    print('-----only +ve values and less than 100 Acceptaple-----')

#output----->print()
#Ouput Formatting----->old style formatting (using commas)
